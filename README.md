...
(en Kaggle: https://acortar.link/vl8Q5S) en colecciones de datos, a los cuales se accede mediante API de Python para
reducir en volumen (AWS free tier tiene limte de 5GB) e insertar en un bucket de Amazon S3 para almcenamiento de archivos json en bruto
